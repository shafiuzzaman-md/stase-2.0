...
analysis_project_path = f'./ASU_TESTCASES/kernel_asu_testcase.project'
...
#Zip the results
zipcommand = [
    'zip', '-r', 'ASU_linux_sa_results.zip', f'{output_dir}'
]
try:
    subprocess.run(zipcommand, check=True)
    print(f"Zipped the results: ASU_linux_sa_results.zip")
