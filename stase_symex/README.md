...
```
# from stase_symex/
python3 setup_kernel_environment.py  ../eval3_linux-main 
```
## **2. Driver and Instrumentation (For Each Vulnerability)**
...
Example:
```
python3 run_analysis.py ../inputs/klee_driver_kbmi_net_init_STACK_EXECUTABLE_19.c  --clang-path /usr/lib/llvm-14/bin/clang   --klee-path /harden/klee_build/bin/klee
```
